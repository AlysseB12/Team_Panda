        ...
        public static async Task Initialize(Hotel_Advisor.Data.Hotel_AdvisorContext context, IServiceProvider services)
        {
            ...
            var Hotels = new Hotel[]
            {
                ...
                new Hotel{
                    ...
                    UserID= "a93f6a42-1b45-4e9b-805c-ae73b79d6cd3" ,
                    Name= "Hotel Brazilia",
                    Description="Only the finest bedrooms with plenty of space and delicious meals served throughout the day.",
                    Address="Largo Vespasiano Julio Veppo 77, Center",
                    City="Brasilia",
                ...
                new Hotel{
                    ...
                    Description="Polished hotel offering modern rooms & ocean views, plus a refined restaurant & a rooftop bar.",
